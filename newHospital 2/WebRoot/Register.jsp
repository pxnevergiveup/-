...
<body>
    ...
    <div class="content">
        <div class="content_left">
            <header class="msg_head">医生信息</header>
            <div class="msg_card">               
                <div class="jieshao">
                    <header>
                        <img src="image/yisheng.jpg" />
                        <span>${requestScope.serDoctor.getDname()}</span>
                        ${requestScope.serDoctor.getKsname()}<br />
                        珠海吉大附属医院 
                    </header>
                    <content>${requestScope.serDoctor.getDjs()}</content>
                    <div class="zixunyuyue">
                        <a class="zixun" href="javascript:alert('\u4ee3\u6269\u5c55')">在线咨询</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="content_right">
            <header class="register_head">工作时间</header>
            <div class="register">
            <c:forEach var="week" items="${requestScope.map.keySet()}">
            	<div class="week">
                    <header class="worktime"></header>
                    	<c:forEach var="timetime" items="${requestScope.map.get(week)}" begin="0" end="3">
                        	<input form="yuyue" type="radio" name="register" class="worktime" value="${week}&${timetime}"/>  
                        </c:forEach>             
                    <div class="menu">
            ...
            <div class="button" id="sub">预约</div>
        </div>
    </div>

<script type="text/javascript" src="js/Jquery.js"></script>
<script type="text/javascript" src="js/link_js/ThreeWebGL.js"></script> 
<script type="text/javascript" src="js/link_js/ThreeExtras.js"></script> 
<script type="text/javascript" src="js/link_js/Detector.js"></script> 
<script type="text/javascript" src="js/link_js/RequestAnimationFrame.js"></script> 
<script type="text/javascript">
	$("#sub").click(function(){	
		var r = window.confirm("确认预约挂号？");
		if(r){
			$.ajax({
	            url: 'GHServlet?index=yuyue&dno=${requestScope.serDoctor.getDno()}',
	            type: 'POST',
